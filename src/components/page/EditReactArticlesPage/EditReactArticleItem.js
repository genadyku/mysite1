...
// import { delArticle } from '../../../redux/sagas/articleSaga'
import { deleteReactArticle } from '../../../redux/reducers/articleSlice'

import { getImageByKey } from '../../utils/getImageByKey'

import Modal from '../../commons/components/Modal'

class EditReactArticleItem extends Component {
	constructor(props) {
		super(props)
		this.state = {
			active: false,
	...
	DeletePost = () => {
		...
		this.props.deleteReactArticle(this.props.article.id)
	}
			...
			<>
				...
				<div className='main-row-edit'>
					...
					<div className='editupd' role='presentation'>
						<Link
							style={{ color: 'green' }}
							to={`/updateReactArticle/${article.slug}`}
						>
							{' '}
