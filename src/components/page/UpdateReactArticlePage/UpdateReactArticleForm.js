...
import { updateReactArticle } from '../../../redux/reducers/articleSlice'
import 'prismjs/components/prism-sql'
import 'prismjs/plugins/line-numbers/prism-line-numbers'

const UpdateReactArticleForm = ({ post, id, updateReactArticle }) => {
	...
	const handleSubmit = (e) => {
		...
		updateReactArticle({ ...edtarticle, id })
	}
...
export default connect(mapStateToProps, { updateReactArticle })(
	UpdateReactArticleForm
)
